            ...
            <div className="space-y-20">
                ...
                <div className="space-y-24">
                    {data.projects.map((project, pIdx) => (
                        <section key={pIdx} className="space-y-10 border-t 
                                                     border-gray-100 
                                                     dark:border-gray-800
                                                       pt-16">
                            <div className="space-y-4">
                                <div className="flex items-center gap-3">
                                    <span className="text-xs uppercase tracking-widest font-extrabold text-indigo-600 dark:text-indigo-400">Projects</span>
